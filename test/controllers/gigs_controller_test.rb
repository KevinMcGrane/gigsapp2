...
class GigsControllerTest < ActionController::TestCase
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post :create, gig: { artist: @gig.artist, date: @gig.date, start_time: @gig.start_time, tickets_remaining: @gig.tickets_remaining, venue_id: @gig.venue_id }
    end
  ...
  test "should update gig" do
    patch :update, id: @gig, gig: { artist: @gig.artist, date: @gig.date, start_time: @gig.start_time, tickets_remaining: @gig.tickets_remaining, venue_id: @gig.venue_id }
    assert_redirected_to gig_path(assigns(:gig))
  end
